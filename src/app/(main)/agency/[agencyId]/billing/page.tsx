    ...
    <>
      ...
      <div className="flex flex-col lg:!flex-row justify-between gap-8 mb-4">
        <PricingCard
          ...
          highlightDescription="Want to modify your plan? You can do this here. If you have further question please, contact support@Atlas Flex.com"
          duration="/ month"
          features={features}
        />
