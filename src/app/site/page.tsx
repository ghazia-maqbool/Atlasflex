        ...
        <MaxWidthWrapper>
          <div className="flex flex-col gap-4 items-center">
            ...
            <div className="text-muted-foreground text-center">
              <p>
              Atlas Flex does everything possible to provide you with a convenient
      ...
      <div className="h-[40rem] w-full rounded-md relative flex flex-col items-center justify-center antialiased">
        <div className="max-w-2xl mx-auto p-4">
          ...
          <p className="text-neutral-500 max-w-lg mx-auto my-2 text-sm text-center relative z-10">
            Discover the power of seamless agency management with Atlas Flex Agency
            CRM. Experience the difference today and revolutionize the way you
            manage your agency with Atlas Flex.
          </p>
